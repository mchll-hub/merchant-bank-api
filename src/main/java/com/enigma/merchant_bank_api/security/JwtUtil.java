package com.enigma.merchant_bank_api.security;
...
public class JwtUtil {
    @Value("${app.merchant-bank-api.jwt-secret}")
    private String jwtSecret;
    @Value("{app.merchant-bank-api.app-name}")
    private String appName;
    @Value("${app.merchant-bank-api.jwtExpirationInSecond}")
